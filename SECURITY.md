...
| **Test Set Memorization & Overfitting** | Miners overfit their adapters to the validation benchmark to score artificially high. | **TEE Enclave Sealing**: The Private Test Set is strictly sealed inside hardware TEE Enclaves (Intel SGX / Intel TDX / AMD SEV-SNP) and is never accessible to miners. |
...
- **Mandatory Reporting Channel**: All security vulnerabilities, bug reports, and sensitive disclosures **MUST be sent exclusively via Direct Message (DM) on Discord** to the verified project maintainers.
  - **Official Discord Server**: [https://discord.gg/23FNT8MP7R](https://discord.gg/23FNT8MP7R)
