...
$BIN node start --port 8545 --p2p-port 9000 --data-dir "$DATA_DIR/node1" > "$DATA_DIR/node1.log" 2>&1 &
PID1=$!
...
$BIN node start --port 8546 --p2p-port 9001 --bootnodes "127.0.0.1:9000" --data-dir "$DATA_DIR/node2" > "$DATA_DIR/node2.log" 2>&1 &
PID2=$!
